                                ...
                                <form method="POST" action="SettingListServlet">
                                    ...
                                    <table >
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Setting Type:</td>
                                                <td><select id="settingType" name="settingType">
                                        <c:forEach var="o" items="${listType}">
                                            <option value="${o.type_id}">${o.type}</option>
                                        </c:forEach>
                                    ...
                                    <tr>
                                        <td>Value:</td>
                                        <td><input class="search" type="text" name="value"></td>
                                    </tr>
                                    <tr>
                                        <td>Order:</td>
                                        <td><input class="search" type="text" name="order"></td>
                                    </tr>
                                    <tr>
                                        <td>Note:</td>
                                        <td><textarea class="search" name="note"  rows="4"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td>Status:</td>
