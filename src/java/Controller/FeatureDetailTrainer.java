 ...
 * @author Admin
 */
@WebServlet(name = "FeatureDetailTrainer", urlPatterns = {"/FeatureDetailTrainer"})
public class FeatureDetailTrainer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("Update")) {
                ...
                //  out.print(iterID);
                request.getRequestDispatcher("jsp/Feature/FeatureDetailTrainer.jsp").forward(request, response);
            }
            if (service.equals("updateFeature")) {
                ...
                request.getRequestDispatcher("FeatureListTrainer").forward(request, response);
            }
