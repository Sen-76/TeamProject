        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("UpdateSetting")) {
               ...
               //out.print(list);
                ...
                request.getRequestDispatcher("/jsp/SettingDetails.jsp").forward(request, response);
            }
            if (service.equals("UpdateDetail")) {
                ...
                String note = request.getParameter("scription");
                request.setAttribute("script", note);
//                out.print(group+set_title+set_value+set_order+set_status+scrip);
                dao1.editSetting(group, group, set_title, set_value, set_order, status, note);
