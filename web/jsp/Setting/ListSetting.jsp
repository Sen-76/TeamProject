                            ...
                            <form action="SearchSet" method="POST">
                                ...
                                <select class="SelectDrop" name="typeId" id="typeId">
                                    ...
                                    <c:forEach var="o" items="${typeList}">
                                        <option value="${o.type_id}" ${ID1==o.type_id ? "selected" : ""}>${o.type_id}</option>
                                    </c:forEach>
                                        ...
                                        <tbody>
                                            <c:forEach var="o" items="${SettingList}">
                                                <tr>
                                                    ...
                                                    <td>${o.note}</td>
                                                    <td>
                                                        <a class="EditLink" href="SettingDetail?go=UpdateSetting&setting_id=${o.setting_id}&Type=${o.type_id}">Edit</a>
