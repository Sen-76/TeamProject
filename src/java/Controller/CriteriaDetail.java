...
public class CriteriaDetail extends HttpServlet {
...
//              out.print(iterID);
                request.getRequestDispatcher("jsp/CriteriaDetails.jsp").forward(request, response);
            }
...
//                out.print(listIterId);
                request.getRequestDispatcher("jsp/AddCriteria.jsp").forward(request, response);
            }
            if (service.equals("addCriteria")) {
                ...
                if (loc.matches("^\\d+$") && weight.matches("^(([1-9]\\d*)|0)(\\.\\d+)?") && order.matches("^\\d+$")) {
                    ...
                    if (!weight.matches("^(([1-9]\\d*)|0)(\\.\\d+)?")) {
                        request.setAttribute("txtTitle", title);
                        request.setAttribute("txtWeight", weight);
                        request.setAttribute("txtLoc", loc);
                        request.setAttribute("txtOrder", order);
                        request.setAttribute("errW", "Input number");
                    }
