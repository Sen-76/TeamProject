package Controller.Iteration;

import ConnectDB.ConnectJDBC;
import DAO.DAOIteration;
import Enitiy.Iteration;
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("addIteration")) {
                ...
                if (submit == null) {
                    ...
                    request.getRequestDispatcher("/jsp/addIteration.jsp").forward(request, response);
                } else {
                    ...
                    if (checkName) {
                        ...
                        Iteration obj = new Iteration(subId, iteName, duration, status);
            ...
            if (service.equals("listAllIteration")) {
                ...
                if (submit == null) {
                    ...
                    request.getRequestDispatcher("/jsp/listIteration.jsp").forward(request, response);
                } else {
