...
public class DAOFunction extends ConnectJDBC {
    ...
    public List<Function1> viewFunctionList(int index, int index1, int index2) {
        ...
        String sql = "select distinct fn.*, af.feature_name, at.team_name, al.class_code, al.class_id, u.fullname,ss.setting_value from `function` fn join feature af on fn.feature_id = af.feature_id join team at on at.team_id  = fn.team_id \n"
                ...
                + "where cl.user_id= ? and at.team_id =? limit 10 offset ?";
    ...
    public List<Function1> viewFeature(int index) {
        List<Function1> list = new ArrayList<>();
        String sql = " select distinct fu.feature_id, f.feature_name \n"
    ...
    public List<Function1> searchByFeature(int index, String feature) {
        List<Function1> list = new ArrayList<>();
        String sql = "select distinct fn.*, af.feature_name, at.team_name, al.class_code, al.class_id, u.fullname,ss.setting_value from `function` fn join feature af on fn.feature_id = af.feature_id join team at on at.team_id  = fn.team_id \n"
                + "join class al on al.class_id = at.class_id join classuser cl on cl.team_id = at.team_id join user u on u.user_id = fn.owner_id  join subject_setting ss on ss.setting_id = fn.complexity_id\n"
                + "where cl.user_id= ? and fn.feature_id = '" + feature + "'";
    ...
    public List<Function1> viewFunctionListTranier(int index, int index2, int index3) {
        List<Function1> list = new ArrayList<>();
        String sql = "select distinct fn.*, af.feature_name, at.team_name, al.class_code, al.class_id,ss.setting_value from `function` fn join feature af on fn.feature_id = af.feature_id join team at on at.team_id  = fn.team_id \n"
                ...
                + "where al.trainer_id= ? and al.class_id=? limit 10 offset ?";
    ...
    public List<Function1> searchByTeamTrainer(String team_id, int index, int index1) {
        List<Function1> list = new ArrayList<>();
        String sql = "select distinct fn.*, af.feature_name, at.team_name, al.class_code, al.class_id,ss.setting_value from `function` fn join feature af on fn.feature_id = af.feature_id join team at on at.team_id  = fn.team_id \n"
                + "                join class al on al.class_id = at.class_id join  user u on u.user_id = al.trainer_id  join subject_setting ss on ss.setting_id = fn.complexity_id\n"
                + "                where at.team_id = '" + team_id + "' and al.trainer_id= ? and al.class_id= ?";
    ...
    public List<Function1> viewTeamTrainer(int index, int index1) {
        List<Function1> list = new ArrayList<>();
        String sql = "select distinct at.team_id , at.team_name from `function` f join team at on f.team_id = at.team_id\n"
                ...
                + "where al.trainer_id = ? and al.class_id = ? ";
    ...
    public List<Function1> searchByNameTrainer(int index, int index1, String function_name) {
        List<Function1> list = new ArrayList<>();
        String sql = "select distinct fn.*, af.feature_name, at.team_name, al.class_code, al.class_id,ss.setting_value from `function` fn join feature af on fn.feature_id = af.feature_id join team at on at.team_id  = fn.team_id \n"
                + "             join class al on al.class_id = at.class_id join  user u on u.user_id = al.trainer_id  join subject_setting ss on ss.setting_id = fn.complexity_id\n"
                + "              where al.trainer_id= ? and al.class_id = ? and fn.function_name like '%" + function_name + "%'";
    ...
    public List<Function1> searchByStatusTrainer(int index,int index1, String status) {
        List<Function1> list = new ArrayList<>();
        String sql = "select distinct fn.*, af.feature_name, at.team_name, al.class_code, al.class_id,ss.setting_value from `function` fn join feature af on fn.feature_id = af.feature_id join team at on at.team_id  = fn.team_id \n"
                + "             join class al on al.class_id = at.class_id join  user u on u.user_id = al.trainer_id  join subject_setting ss on ss.setting_id = fn.complexity_id\n"
                + "              where al.trainer_id= ? and al.class_id = ? and fn.status = '" + status + "'";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(dao.searchByStatus(1, "1"));
